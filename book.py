...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  4 10:30:07 2022

@author: valance

Tree-Transformer Prototype on Simplifying Books
...
if CUDA:
    ...
    glove_path = '/Users/valance/Dropbox/AI/data/glove.6B/'
...
def evaluate_text(model, text):
    ...
    output_words = evaluate(model, text)
